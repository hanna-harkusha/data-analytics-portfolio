...
### Power BI
1.   [Retail Sales Performance Dashboard]() — sales, budget vs actual, previous year comparison, inventory, product hierarchy, regional revenue dynamics, DAX measures, Power Query, data modeling.
